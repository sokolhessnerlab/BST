function [subjData] = IATv4(subjID, day, testMode, wind, blk, wht, gry, rect)
    %%
...
lengthOfTrial = 10; %Time limit for each trial in seconds 
...
for ind=1:length(trialOrder)
    ...
    while GetSecs - stimOnset(ind) < lengthOfTrial
