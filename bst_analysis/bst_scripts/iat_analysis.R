...
IATanalytics <- function(IAT, Trials, First){
  ...
  Block2newmean <- mean(IAT2$RT[IAT2$blockNum==2 & IAT2$correct==0]) + 600
  Block3newmean <- mean(IAT2$RT[IAT2$blockNum==3 & IAT2$correct==0]) + 600
  Block5newmean <- mean(IAT2$RT[IAT2$blockNum==5 & IAT2$correct==0]) + 600
  Block6newmean <- mean(IAT2$RT[IAT2$blockNum==6 & IAT2$correct==0]) + 600

  i <- 1 # define i counting variable for while loop
  while (i <= nrow(IAT2)) { # create while loop for Block 2 incorrect trial replacement
    if (IAT2$blockNum[i] == 2 && IAT2$correct[i] == 1) {
  ...
  while (i <= nrow(IAT2)) { # create while loop for Block 3 incorrect trial replacement
    if (IAT2$blockNum[i] == 3 && IAT2$correct[i] == 1) {
  ...
  while (i <= nrow(IAT2)) { # create while loop for Block 5 incorrect trial replacement
    if (IAT2$blockNum[i] == 5 && IAT2$correct[i] == 1) {
  ...
  while (i <= nrow(IAT2)) { # create while loop for Block 6 incorrect trial replacement
    if (IAT2$blockNum[i] == 6 && IAT2$correct[i] == 1) {
      IAT2$RT[i] <- Block6newmean }
    i <- i + 1
  }

  # Step 5a: Calculate standard deviations for all trials in blocks 2 & 5 as well as 3 & 6
  sd25 <- sd(IAT2$RT[IAT2$blockNum==2 | IAT2$blockNum==5])
  sd36 <- sd(IAT2$RT[IAT2$blockNum==3 | IAT2$blockNum==6])
  ...
  mdiff25 <- mean(IAT2$RT[IAT2$blockNum==5]) - mean(IAT2$RT[IAT2$blockNum==2]) #first mean difference (blocks 5 - 2)
  mdiff36 <- mean(IAT2$RT[IAT2$blockNum==6]) - mean(IAT2$RT[IAT2$blockNum==3]) #second mean difference (blocks 6 - 3)
  ...
  while (i <= nrow(IATodd)) { # create while loop for Block 2 incorrect trial replacement
    if (IATodd$blockNum[i] == 2 && IATodd$correct[i] == 1) {
  ...
  while (i <= nrow(IATodd)) { # create while loop for Block 3 incorrect trial replacement
    if (IATodd$blockNum[i] == 3 && IATodd$correct[i] == 1) {
  ...
  while (i <= nrow(IATodd)) { # create while loop for Block 5 incorrect trial replacement
    if (IATodd$blockNum[i] == 5 && IATodd$correct[i] == 1) {
  ...
  while (i <= nrow(IATodd)) { # create while loop for Block 6 incorrect trial replacement
    if (IATodd$blockNum[i] == 6 && IATodd$correct[i] == 1) {
      IATodd$RT[i] <- Block6oddnewmean }
    i <- i + 1
  }

  # Step 5b: Calculate standard deviations for all trials in blocks 2 & 5 as well as 3 & 6
  sd25odd <- sd(IATodd$RT[IATodd$blockNum==2 | IATodd$blockNum==5])
  sd36odd <- sd(IATodd$RT[IATodd$blockNum==3 | IATodd$blockNum==6])
  ...
  mdiff25odd <- mean(IATodd$RT[IATodd$blockNum==5]) - mean(IATodd$RT[IATodd$blockNum==2]) #first mean difference (blocks 5 - 2)
  mdiff36odd <- mean(IATodd$RT[IATodd$blockNum==6]) - mean(IATodd$RT[IATodd$blockNum==3]) #second mean difference (blocks 6 - 3)
  ...
  Block2evennewmean <- mean(IATeven$RT[IATeven$blockNum==2 & IATeven$correct==0]) + 600
  Block3evennewmean <- mean(IATeven$RT[IATeven$blockNum==3 & IATeven$correct==0]) + 600
  Block5evennewmean <- mean(IATeven$RT[IATeven$blockNum==5 & IATeven$correct==0]) + 600
  Block6evennewmean <- mean(IATeven$RT[IATeven$blockNum==6 & IATeven$correct==0]) + 600

  i <- 1 # define i counting variable for while loop
  while (i <= nrow(IATeven)) { # create while loop for Block 2 incorrect trial replacement
    if (IATeven$blockNum[i] == 2 && IATeven$correct[i] == 1) {
  ...
  while (i <= nrow(IATeven)) { # create while loop for Block 3 incorrect trial replacement
    if (IATeven$blockNum[i] == 3 && IATeven$correct[i] == 1) {
  ...
  while (i <= nrow(IATeven)) { # create while loop for Block 5 incorrect trial replacement
    if (IATeven$blockNum[i] == 5 && IATeven$correct[i] == 1) {
  ...
  while (i <= nrow(IATeven)) { # create while loop for Block 6 incorrect trial replacement
    if (IATeven$blockNum[i] == 6 && IATeven$correct[i] == 1) {
      IATeven$RT[i] <- Block6evennewmean }
    i <- i + 1
  }

  # Step 5c: Calculate standard deviations for all trials in blocks 2 & 5 as well as 3 & 6
  sd25even <- sd(IATeven$RT[IATeven$blockNum==2 | IATeven$blockNum==5])
  sd36even <- sd(IATeven$RT[IATeven$blockNum==3 | IATeven$blockNum==6])
  ...
  mdiff25even <- mean(IATeven$RT[IATeven$blockNum==5]) - mean(IATeven$RT[IATeven$blockNum==2]) #first mean difference (blocks 5 - 2)
  mdiff36even <- mean(IATeven$RT[IATeven$blockNum==6]) - mean(IATeven$RT[IATeven$blockNum==3]) #second mean difference (blocks 6 - 3)
